...
```
Equip_10/
├── Data/        datasets per sprint (see Data/README_en.md)
├── Scripts/     notebooks per sprint: ETL, EDA, KPIs (see Scripts/README_en.md)
└── Results/     presentations & deliverables per sprint (see Results/README_en.md)
```
